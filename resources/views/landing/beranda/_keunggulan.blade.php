        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div class="lg:col-span-7 bg-[#121212] border border-white/5 rounded-3xl p-8 sm:p-10 flex flex-col justify-between hover:border-[#f2994a]/30 transition-all duration-300 group" data-aos="fade-up">
                <div class="space-y-6">
                    ...
                    <div class="space-y-3">
                        <h3 class="text-xl sm:text-2xl font-extrabold text-white group-hover:text-[#f2994a] transition-all">{{ \App\Helpers\StaticContent::K1_TITLE }}</h3>
                        <p class="text-gray-400 text-sm leading-relaxed max-w-xl">{!! \App\Helpers\StaticContent::K1_DESC !!}</p>
                    </div>
                </div>
                <div class="pt-8">
                    <a href="{{ route('katalog.user') }}" class="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#f2994a] hover:text-[#e28a44] transition-all group-hover:translate-x-1">
                        {{ \App\Helpers\StaticContent::CTA_SELENGKAPNYA }} <i class="ph-bold ph-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="lg:col-span-5 bg-[#121212] border border-white/5 rounded-3xl p-8 sm:p-10 flex flex-col justify-between hover:border-[#f2994a]/30 transition-all duration-300 group" data-aos="fade-up" data-aos-delay="100">
                <div class="space-y-6">
                    ...
                    <div class="space-y-3">
                        <h3 class="text-xl font-extrabold text-white group-hover:text-[#f2994a] transition-all">{{ \App\Helpers\StaticContent::K2_TITLE }}</h3>
                        <p class="text-gray-400 text-sm leading-relaxed">{!! \App\Helpers\StaticContent::K2_DESC !!}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-5 bg-[#121212] border border-white/5 rounded-3xl p-8 sm:p-10 flex flex-col justify-between hover:border-[#f2994a]/30 transition-all duration-300 group" data-aos="fade-up" data-aos-delay="200">
                <div class="space-y-6">
                    ...
                    <div class="space-y-3">
                        <h3 class="text-xl font-extrabold text-white group-hover:text-[#f2994a] transition-all">{{ \App\Helpers\StaticContent::K3_TITLE }}</h3>
                        <p class="text-gray-400 text-sm leading-relaxed">{!! \App\Helpers\StaticContent::K3_DESC !!}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-7 bg-gradient-to-br from-[#e28a44] to-[#f2994a] rounded-3xl p-8 sm:p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-8 shadow-lg shadow-[#f2994a]/10 hover:shadow-[#f2994a]/20 hover:scale-[1.01] transition-all duration-300 group" data-aos="fade-up" data-aos-delay="300">
                <div class="space-y-6 md:max-w-md">
                    <div class="space-y-3">
                        <h3 class="text-2xl font-black text-black leading-tight">{{ \App\Helpers\StaticContent::K4_TITLE }}</h3>
                        <p class="text-black/80 text-sm leading-relaxed">{!! \App\Helpers\StaticContent::K4_DESC !!}</p>
                    </div>
                    <div class="pt-2">
                        <a href="{{ route('profil.perusahaan') }}" class="inline-block bg-black text-[#f2994a] hover:bg-black/90 hover:text-white px-6 py-3 rounded-xl text-xs font-bold uppercase tracking-wider shadow-md transition-all">
