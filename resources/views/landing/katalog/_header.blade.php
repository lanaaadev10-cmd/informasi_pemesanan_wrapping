...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6 z-10 relative">
    <div>
        <span class="text-[10px] text-gray-500 font-bold uppercase tracking-widest font-mono">LAYANAN UNGGULAN</span>
    ...
    <div class="relative max-w-xs w-full">
        ...
        <input type="text" 
               ...
               class="w-full bg-[#121212]/80 border border-white/5 rounded-2xl pl-10 pr-4 py-2.5 text-xs text-white placeholder-gray-500 focus:outline-none transition-all shadow-inner" 
               style="focus:border-color: var(--accent-color);">
    </div>
</div>