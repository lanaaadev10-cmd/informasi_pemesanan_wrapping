    ...
    <nav class="fixed top-0 w-full z-[100] {{ $is_frontend ? 'bg-[#0a0a0a]/85 border-b border-white/5 text-white' : 'bg-white/80 border-b border-gray-100 text-gray-900' }} backdrop-blur-md transition-all duration-300"
        ...
        <div class="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center gap-10">
                <a href="{{ route('home') }}" class="text-sm font-medium {{ Request::routeIs('home') ? 'nav-link-active' : ($is_frontend ? 'text-gray-300 hover:text-[#f2994a]' : 'text-gray-500 hover:text-orange-600') }} transition-colors">{{ \App\Helpers\StaticContent::NAV_BERANDA }}</a>
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="p-8 space-y-6">
                <div class="space-y-1">
                    <a href="{{ route('home') }}" @click="mobileMenuOpen = false" class="block text-2xl font-bold {{ Request::routeIs('home') ? 'text-[#f2994a]' : ($is_frontend ? 'text-gray-300 hover:text-[#f2994a]' : 'text-gray-600') }} transition-colors">{{ \App\Helpers\StaticContent::NAV_BERANDA }}</a>
                    ...
                    @if($is_frontend)
                        ...
                        @auth
                            <div class="grid grid-cols-1 gap-4">
                                <a href="{{ route('katalog.user') }}" @click="mobileMenuOpen = false" class="flex items-center justify-center py-4 bg-[#f2994a] text-black font-extrabold rounded-2xl shadow-lg uppercase tracking-wider text-sm transition-transform hover:scale-105">{{ \App\Helpers\StaticContent::NAV_PESANAN }}</a>
        ...
        <footer class="bg-[#060606] pt-20 pb-12 border-t border-white/5">
            <div class="max-w-7xl mx-auto px-6 text-center">
                ...
                <div class="flex justify-center gap-6 mb-10">
                    <a href="{{ \App\Helpers\StaticContent::INSTAGRAM_URL }}" target="_blank" aria-label="{{ \App\Helpers\StaticContent::FOOTER_INSTAGRAM }}" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-[#f2994a] hover:border-[#f2994a] hover:bg-white/10 transition-all duration-300">
                        <i class="ph-bold ph-instagram-logo text-lg"></i>
                    </a>
                    <a href="mailto:{{ \App\Helpers\StaticContent::COMPANY_EMAIL }}" aria-label="Email" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-[#f2994a] hover:border-[#f2994a] hover:bg-white/10 transition-all duration-300">
                        <i class="ph-bold ph-envelope text-lg"></i>
                    </a>
                    <a href="{{ \App\Helpers\StaticContent::COMPANY_WHATSAPP }}" target="_blank" aria-label="WhatsApp" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-[#f2994a] hover:border-[#f2994a] hover:bg-white/10 transition-all duration-300">
